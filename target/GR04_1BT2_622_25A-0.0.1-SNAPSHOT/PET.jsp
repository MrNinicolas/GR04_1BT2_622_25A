    ...
    <div class="row">
        ...
        <div class="col-md-8">
            <div class="d-flex justify-content-between align-items-center mb-3">
                ...
                <h3 class="mb-0">
                    Pets <i class="fa-solid fa-map-location-dot"></i>
                </h3>
                        ...
                        <div class="card border-0 rounded-3">
                            <div class="card-body p-4">
                                ...
                                <p class="card-text text-secondary small mb-4">
                                    <i class="fas fa-map-marker-alt me-2"></i>${pet.species}
                                </p>
                                <p class="card-text text-secondary small mb-4">
                                    <i class="fa-solid fa-house me-2"></i>${pet.breed}
                                </p>
                                <div class="d-flex justify-content-end">
                                    <!-- Botón de editar -->
                                    <a
                                            href="ManagePetsController?route=edit&idAddress=${pet.idPet}"
                                            class="btn btn-primary btn-sm me-2 px-3"> <i
                                            class="fas fa-pen"></i> Edit
                                    </a>
                                    <!-- Botón de eliminar -->
                                    <a
                                            href="ManagePetsController?route=delete&idAddress=${pet.idPet}"
        ...
        <div class="modal-content">
            ...
            <form action="ManagePetsController?route=saveNew"
                ...
                <div class="modal-body">
                    ...
                    <div class="row g-4">
                        ...
                        <div class="col-md-6">
                            <label for="AddSpecies" class="form-label fw-semibold">Species
                                (Optional)</label> <input id="AddSpecies" type="text"
                                                          class="form-control rounded-3" name="txtCompany"
                    ...
                    <div class="row g-4 mt-2">
                        <div class="col-md-6">
                            <label for="AddOwnerName" class="form-label fw-semibold">Owner Name
                                            ...
                                            class="form-control rounded-3" name="txtMainStreet"
                                            placeholder="Enter owner name" required>
                        </div>
                        <div class="col-md-6">
                            <label for="AddAge" class="form-label fw-semibold">Age
                            </label> <input id="AddAge" type="text"
                    ...
                    <div class="row g-4 mt-2">
                        <div class="col-md-6">
                            <label for="AddWeight" class="form-label fw-semibold">Weight</label>
                            <input id="AddWeight" type="text"
                                   class="form-control rounded-3" name="txtPostcode"
        ...
        <div class="modal-content">
            ...
            <form action="ManagePetsController?route=saveExisting"
                ...
                <div class="modal-body">
                    ...
                    <div class="row">
                        <input type="hidden" name="txtId" value="${pet.idPet}">
                        <div class="col-md-6 mb-3">
                        ...
                        <div class="col-md-6 mb-3">
                            <label for="EditSpecies" class="form-label fw-bold">Species
                                (Optional)</label> <input id="EditSpecies" type="text"
                                                          class="form-control" name="txtCompany"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="EditBreed" type="text" class="form-control"
                                   name="txtProvince" value="${pet.breed}"
                        ...
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="EditColor" type="text" class="form-control"
                                   name="txtCity" value="${pet.color}" placeholder="Enter city"
                                   required>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            <label for="EditOwnerName" class="form-label fw-bold">
                                Owner Name</label> <input id="EditOwnerName" type="text"
                                                          class="form-control" name="txtMainStreet"
                                                          value="${pet.ownerName}" placeholder="Enter main street"
                                                          required>
                        </div>
                        <div class="col-md-6 mb-3">
                            <label for="EditAge" class="form-label fw-bold">Age
                            </label> <input id="EditAge" type="text"
                                            class="form-control" name="txtSecondaryStreet"
                                            value="${pet.age}"
                    ...
                    <div class="row">
                        <div class="col-md-6 mb-3">
                            ...
                            <input id="EditWeight" type="text" class="form-control"
                                   name="txtPostcode" value="${pet.weight}"
    ...
    <div class="modal-dialog modal-dialog-centered">
        <div class="modal-content">
            ...
            <div class="modal-body text-center">
                ...
                <p class="card-text text-secondary small mb-4">
                    <i class="fa-solid fa-road me-2"></i>${pet.color}
                </p>
                <p class="card-text text-secondary small mb-4">
                    <i class="fa-solid fa-envelope me-2"></i></i>${pet.ownerName}
                </p>
            </div>
            <div class="modal-footer justify-content-center">
                ...
                <form
                        action="ManagePetsController?route=accept&idAddress=${pet.idPet}"
                        method="POST">
